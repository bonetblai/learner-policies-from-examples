...
class InstanceData:
    ...
    _gfa_state_idx_to_ss_state_idx: Dict[int, int]
    _initial_gfa_state_idxs: List[int]  # in cases we need multiple initial states
    _initial_mimir_ss_state_idxs: List[int]  # in cases we need multiple initial states
    ...
    @property
    def gfa_state_idx_to_ss_state_idx(self):
        return self._gfa_state_idx_to_ss_state_idx
    ...
    @property
    def initial_mimir_ss_state_idxs(self):
        return self._initial_mimir_ss_state_idxs
