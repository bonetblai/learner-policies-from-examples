...
(define (problem p012-microban-sequential)
  ...
  (:init
    ...
    (ADJ-DOWN  pos-1-1 pos-1-2)
    (ADJ-DOWN  pos-1-2 pos-1-3)
    (ADJ-DOWN  pos-1-3 pos-1-4)
    (ADJ-DOWN  pos-1-4 pos-1-5)
    (ADJ-DOWN  pos-1-5 pos-1-6)
    (ADJ-DOWN  pos-1-6 pos-1-7)
    (ADJ-DOWN  pos-1-7 pos-1-8)

    (ADJ-DOWN  pos-2-1 pos-2-2)
    (ADJ-DOWN  pos-2-2 pos-2-3)
    (ADJ-DOWN  pos-2-3 pos-2-4)
    (ADJ-DOWN  pos-2-4 pos-2-5)
    (ADJ-DOWN  pos-2-5 pos-2-6)
    (ADJ-DOWN  pos-2-6 pos-2-7)
    (ADJ-DOWN  pos-2-7 pos-2-8)

    (ADJ-DOWN  pos-3-1 pos-3-2)
    (ADJ-DOWN  pos-3-2 pos-3-3)
    (ADJ-DOWN  pos-3-3 pos-3-4)
    (ADJ-DOWN  pos-3-4 pos-3-5)
    (ADJ-DOWN  pos-3-5 pos-3-6)
    (ADJ-DOWN  pos-3-6 pos-3-7)
    (ADJ-DOWN  pos-3-7 pos-3-8)

    (ADJ-DOWN  pos-4-1 pos-4-2)
    (ADJ-DOWN  pos-4-2 pos-4-3)
    (ADJ-DOWN  pos-4-3 pos-4-4)
    (ADJ-DOWN  pos-4-4 pos-4-5)
    (ADJ-DOWN  pos-4-5 pos-4-6)
    (ADJ-DOWN  pos-4-6 pos-4-7)
    (ADJ-DOWN  pos-4-7 pos-4-8)

    (ADJ-DOWN  pos-5-1 pos-5-2)
    (ADJ-DOWN  pos-5-2 pos-5-3)
    (ADJ-DOWN  pos-5-3 pos-5-4)
    (ADJ-DOWN  pos-5-4 pos-5-5)
    (ADJ-DOWN  pos-5-5 pos-5-6)
    (ADJ-DOWN  pos-5-6 pos-5-7)
    (ADJ-DOWN  pos-5-7 pos-5-8)

    (ADJ-DOWN  pos-6-1 pos-6-2)
    (ADJ-DOWN  pos-6-2 pos-6-3)
    (ADJ-DOWN  pos-6-3 pos-6-4)
    (ADJ-DOWN  pos-6-4 pos-6-5)
    (ADJ-DOWN  pos-6-5 pos-6-6)
    (ADJ-DOWN  pos-6-6 pos-6-7)
    (ADJ-DOWN  pos-6-7 pos-6-8)

    (ADJ-DOWN  pos-7-1 pos-7-2)
    (ADJ-DOWN  pos-7-2 pos-7-3)
    (ADJ-DOWN  pos-7-3 pos-7-4)
    (ADJ-DOWN  pos-7-4 pos-7-5)
    (ADJ-DOWN  pos-7-5 pos-7-6)
    (ADJ-DOWN  pos-7-6 pos-7-7)
    (ADJ-DOWN  pos-7-7 pos-7-8)

    (ADJ-DOWN  pos-8-1 pos-8-2)
    (ADJ-DOWN  pos-8-2 pos-8-3)
    (ADJ-DOWN  pos-8-3 pos-8-4)
    (ADJ-DOWN  pos-8-4 pos-8-5)
    (ADJ-DOWN  pos-8-5 pos-8-6)
    (ADJ-DOWN  pos-8-6 pos-8-7)
    (ADJ-DOWN  pos-8-7 pos-8-8)

    (ADJ-DOWN  pos-9-1 pos-9-2)
    (ADJ-DOWN  pos-9-2 pos-9-3)
    (ADJ-DOWN  pos-9-3 pos-9-4)
    (ADJ-DOWN  pos-9-4 pos-9-5)
    (ADJ-DOWN  pos-9-5 pos-9-6)
    (ADJ-DOWN  pos-9-6 pos-9-7)
    (ADJ-DOWN  pos-9-7 pos-9-8)
